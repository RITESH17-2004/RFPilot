    ...
    <div className="h-screen bg-[#f0f4f8] flex flex-col overflow-hidden">
      ...
      <header className="bg-[#0a1628] h-[76px] px-8 flex items-center justify-between shrink-0 shadow-xl z-20 border-b border-white/5">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-md font-black text-white tracking-tight">Institutional Control: <span className="text-blue-400">AMENDMENT MODE</span></h1>
        ...
        <div className="w-[60%] lg:w-[65%] bg-[#1e1e2e] relative border-r border-[#0033a0]/10 flex flex-col shadow-inner">
          <div className="absolute top-6 left-6 z-10 flex items-center gap-3">
             ...
             <button 
                ...
                className="p-2.5 bg-white text-slate-500 hover:text-[#0033a0] rounded-xl shadow-lg hover:bg-slate-50 transition-all border border-slate-200 active:scale-95"
          ...
          <div className="absolute bottom-6 right-6 px-6 py-4 bg-[#0a1628]/90 backdrop-blur-xl text-white rounded-[1.5rem] border border-white/10 shadow-2xl">
            <div className="flex items-center gap-5">
                <div className="text-right">
                    <p className="text-[9px] text-blue-300/80 font-black uppercase tracking-widest mb-0.5">Registry Status</p>
        ...
        <div className="w-[40%] lg:w-[35%] bg-white flex flex-col shadow-[-20px_0_50px_-10px_rgba(0,0,0,0.05)] overflow-y-auto custom-scrollbar">
          <div className="p-10 space-y-10">
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-black text-[#0033a0] bg-blue-50 px-3 py-1 rounded-full uppercase tracking-widest border border-blue-100">Official Change Log</span>
                </div>
                <div className="relative group">
                  <textarea 
                    ...
                    required
                  />
                  <div className={`absolute bottom-6 right-6 p-2.5 rounded-xl transition-all ${changeSummary.trim() ? 'bg-[#0033a0] text-white shadow-md shadow-blue-900/20' : 'bg-slate-200 text-slate-400'}`}>
              ...
              <button 
                ...
                className="w-full py-5 bg-[#0a1628] hover:bg-[#122654] text-white rounded-[2rem] font-black uppercase tracking-[0.2em] text-xs transition-all shadow-xl shadow-[#0a1628]/10 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] border border-white/10 group"
              >
                {loading ? (
            ...
            <div className="pt-8 border-t border-slate-100">
               ...
               {/* Impact Warning Card */}
               <div className="mb-6 p-6 bg-blue-50/50 rounded-3xl border border-[#0033a0]/10 flex gap-4">
                 <div className="w-10 h-10 bg-[#0033a0]/10 text-[#0033a0] rounded-2xl flex items-center justify-center shrink-0">
                     <AlertCircle size={18} />
                 </div>
                 <div>
